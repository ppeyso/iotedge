...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet
{
    ...
    public class ModuleManagementHttpClient : IModuleManager, IIdentityManager
    {
        ...
        public ModuleManagementHttpClient(Uri managementUri, string edgeletApiVersion)
        {
            this.managementUri = Preconditions.CheckNotNull(managementUri, nameof(managementUri));
            Preconditions.CheckNonWhiteSpace(edgeletApiVersion, nameof(edgeletApiVersion));
            this.inner = this.GetVersionedModuleManagement(edgeletApiVersion);
        }
        ...
        public Task PrepareUpdate(ModuleSpec moduleSpec) => this.inner.PrepareUpdate(moduleSpec);

        ModuleManagementHttpClientVersioned GetVersionedModuleManagement(string edgeletApiVersion)
        {
            ApiVersion supportedVersion = this.GetSupportedVersion(edgeletApiVersion, Constants.EdgeletManagementApiVersion);
